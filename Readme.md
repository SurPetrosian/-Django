...
# 📦 Формы
### ✅ Задание 1: CRUD ля модели `Product` и валидация названия и описания продукта
...
### ✅ Задание 2: Кастомная валидация цены продукта

- 💰 Реализована кастомная валидация цены (`clean_price`): цена не может быть отрицательной.

### ✅ Задание 3: Стилизация через метод __init__
